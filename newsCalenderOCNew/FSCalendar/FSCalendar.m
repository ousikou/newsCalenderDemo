...
- (void)invalidateAppearanceForCell:(WzhCollectionViewCell *)cell forDate:(NSDate *)date;
...
- (void)reloadDataForCell:(WzhCollectionViewCell *)cell atIndexPath:(NSIndexPath *)indexPath;
...
{   
    ...
    [collectionView registerClass:[WzhCollectionViewCell class] forCellWithReuseIdentifier:FSCalendarDefaultCellReuseIdentifier];
    ...
    [collectionView registerNib:[UINib nibWithNibName:@"WzhCollectionViewCell" bundle:nil] forCellWithReuseIdentifier:@"WzhCollectionViewCell"];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    WzhCollectionViewCell *cell = [self.dataSourceProxy calendar:self cellForDate:date atMonthPosition:monthPosition];
//    if (!cell) {
        cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:@"WzhCollectionViewCell" forIndexPath:indexPath];
//    }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    FSCalendarMonthPosition monthPosition = [self.calculator monthPositionForIndexPath:indexPath];
    WzhCollectionViewCell *cell;
    if (monthPosition == FSCalendarMonthPositionCurrent) {
        cell = (WzhCollectionViewCell *)[collectionView cellForItemAtIndexPath:indexPath];
    } else {
...
{
    if (![cell isKindOfClass:[WzhCollectionViewCell class]]) {
        return;
    }
    NSDate *date = [self.calculator dateForIndexPath:indexPath];
    FSCalendarMonthPosition monthPosition = [self.calculator monthPositionForIndexPath:indexPath];
    [self.delegateProxy calendar:self willDisplayCell:(WzhCollectionViewCell *)cell forDate:date atMonthPosition:monthPosition];
}
...
- (void)registerClass:(Class)cellClass forCellReuseIdentifier:(NSString *)identifier
{
    ...
    if (![cellClass isSubclassOfClass:[WzhCollectionViewCell class]]) {
        [NSException raise:@"The cell class must be a subclass of WzhCollectionViewCell." format:@""];
    }
...
- (WzhCollectionViewCell *)dequeueReusableCellWithIdentifier:(NSString *)identifier forDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position;
{
    if (!identifier.length) {
        [NSException raise:FSCalendarInvalidArgumentsExceptionName format:@"This identifier must not be nil and must not be an empty string."];
    }
    ...
    WzhCollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:identifier forIndexPath:indexPath];
    return cell;
}

- (nullable WzhCollectionViewCell *)cellForDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position
{
    NSIndexPath *indexPath = [self.calculator indexPathForDate:date atMonthPosition:position];
    return (WzhCollectionViewCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
}

- (NSDate *)dateForCell:(WzhCollectionViewCell *)cell
{
    NSIndexPath *indexPath = [self.collectionView indexPathForCell:cell];
    return [self.calculator dateForIndexPath:indexPath];
}

- (FSCalendarMonthPosition)monthPositionForCell:(WzhCollectionViewCell *)cell
{
    NSIndexPath *indexPath = [self.collectionView indexPathForCell:cell];
    return [self.calculator monthPositionForIndexPath:indexPath];
}

- (NSArray<WzhCollectionViewCell *> *)visibleCells
{
    return [self.collectionView.visibleCells filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(id  _Nullable evaluatedObject, NSDictionary<NSString *,id> * _Nullable bindings) {
        return [evaluatedObject isKindOfClass:[WzhCollectionViewCell class]];
    }]];
}
...
- (void)deselectDate:(NSDate *)date
{
    ...
    if ([_collectionView.indexPathsForSelectedItems containsObject:indexPath]) {
        ...
        WzhCollectionViewCell *cell = (WzhCollectionViewCell *)[_collectionView cellForItemAtIndexPath:indexPath];
        cell.selected = NO;
    }
}
...
- (void)selectDate:(NSDate *)date scrollToDate:(BOOL)scrollToDate atMonthPosition:(FSCalendarMonthPosition)monthPosition
{
    ...
    if (monthPosition==FSCalendarMonthPositionPrevious||monthPosition==FSCalendarMonthPositionNext) {
        ...
        WzhCollectionViewCell *cell = (WzhCollectionViewCell *)[_collectionView cellForItemAtIndexPath:targetIndexPath];
...
- (void)reloadDataForCustomizeCell:(WzhCollectionViewCell *)cell atIndexPath:(NSIndexPath *)indexPath {
...
- (void)reloadDataForCell:(WzhCollectionViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.dayLabel.text = [self.dataSourceProxy calendar:self titleForDate:date] ?: @([self.gregorian component:NSCalendarUnitDay fromDate:date]).stringValue;
