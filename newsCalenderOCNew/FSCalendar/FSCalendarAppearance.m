...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _titleColors[@(FSCalendarCellStateSelected)]    = [UIColor orangeColor];
        ...
        _titleColors[@(FSCalendarCellStateToday)]       = [UIColor purpleColor];
        ...
        _subtitleColors[@(FSCalendarCellStateSelected)]    = [UIColor purpleColor];
        ...
        _subtitleColors[@(FSCalendarCellStateToday)]       = [UIColor purpleColor];
