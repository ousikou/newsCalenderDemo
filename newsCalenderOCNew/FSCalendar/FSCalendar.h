 ...
 */
- (__kindof WzhCollectionViewCell *)calendar:(FSCalendar *)calendar cellForDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position;
...
/**
 ...
 @return A valid WzhCollectionViewCell object.
 */
- (__kindof WzhCollectionViewCell *)dequeueReusableCellWithIdentifier:(NSString *)identifier forDate:(NSDate *)date atMonthPosition:(FSCalendarMonthPosition)position;
 ...
 */
- (nullable NSDate *)dateForCell:(WzhCollectionViewCell *)cell;
...
/**
 ...
 @return An array of WzhCollectionViewCell objects. If no cells are visible, this method returns an empty array.
 */
- (NSArray<__kindof WzhCollectionViewCell *> *)visibleCells;
